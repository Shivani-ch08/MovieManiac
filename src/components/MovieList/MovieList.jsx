...
const MovieList = ({type, title, emoji}) => {
    ...
    useEffect(() => {
        fetchMovies();
      //await fetch("https://api.themoviedb.org/3/movie/popular?api_key=d8af690893d86ec97e0af2269b9023a4")
    ...
    const fetchMovies=async () => {
        const response= await fetch(`https://api.themoviedb.org/3/movie/${type}?api_key=d8af690893d86ec97e0af2269b9023a4`)
